...
import com.bitsnbytes.product.ProductApplication;
...
public class GlobalExceptionHandler {
	...
	GlobalExceptionHandler(ProductApplication productApplication) {
		this.productApplication = productApplication;
	}

	@ExceptionHandler(CategoryAlreadyExistsException.class)
	public ResponseEntity<ExceptionResponseDTO> handleCategoryAlradyExistsException(CategoryAlreadyExistsException ex,WebRequest webRequest)
	{
